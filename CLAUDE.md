...
- **Pas encore fait** : pièces jointes (Storage), commentaires dédiés, QR code, notifications email à la création/changement de statut (seule l'assignation déclenche un email pour l'instant), SMS, relances pg_cron.
